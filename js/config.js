...
// シームレス地質図関連URL
export const SEAMLESS_TILE_URL = 'https://gbank.gsj.jp/seamless/v2/api/1.3.1/tiles/{z}/{y}/{x}.png';
export const SEAMLESS_LEGEND_URL = 'https://gbank.gsj.jp/seamless/v2/api/1.3.1/legend.json';
